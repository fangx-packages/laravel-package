...
class OptionalPackages
{
    ...
    public function setUpNamespace(string $name)
    {
        ...
        $content = file_get_contents(__DIR__ . '/resources/ServiceProvider.stub');
        $content = str_replace('%NAMESPACE%', $namespace, $content);
        file_put_contents(__DIR__ . '/../src/ServiceProvider.php', $content);
        @unlink(__DIR__ . '/../src/.gitkeep');
        $this->composerDefinition['autoload']['psr-4'][$namespace . '\\'] = 'src/';
        $this->composerDefinition['extra']['laravel']['providers'] = [$namespace . '\\ServiceProvider'];
        $this->composerDefinition['extra']['laravel']['aliases'] = [];
    }
